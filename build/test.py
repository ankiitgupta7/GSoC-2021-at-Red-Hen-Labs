...
class vehicle(object):
    ...
    def move(self,r,fov,index,hideout,nAgents,toggleAlarm):
        ...
        elif(alarm == 0 and safeTime[index][0] > safeTime[index][0]*.01):    # vervets keeps moving till safetime becomes 0
            v = 2 * safeTime[index][0] / 1000
            safeTime[index][0] -= safeTime[index][0]*.01 # TBD fear level on visually spotting predator recently
